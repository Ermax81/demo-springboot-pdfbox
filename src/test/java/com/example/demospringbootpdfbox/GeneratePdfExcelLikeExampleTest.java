...
import static com.example.demospringbootpdfbox.TestUtils.*;
...
// Source: https://github.com/vandeseer/easytable/blob/master/src/test/java/org/vandeseer/integrationtest/ExcelLikeExampleTest.java
// Source: https://github.com/vandeseer/easytable
public class GeneratePdfExcelLikeExampleTest {
    ...
    private static final String FILE_NAME_OUTPUT = "excelLike-test.pdf";
    @Test
    public void createDocumentWithExcelLikeTables() throws IOException {
        TestUtils.createAndSaveDocumentWithTables(FILE_NAME_OUTPUT,
                createSimpleExampleTable(),
                createComplexExampleTable()
        );

        CompareResult compareResult = new PdfComparator<>(getExpectedPdfFor(FILE_NAME), getActualPdfFor(FILE_NAME_OUTPUT)).compare();
    ...
    private ImageCell.ImageCellBuilder createAndGetTuxImageCellBuilder() throws IOException {
    ...
    private TextCell.TextCellBuilder createAndGetTuxTextCellBuilder() {
    ...
    private TextCell.TextCellBuilder createAndGetTorvaldsQuoteCellBuilder() {
    ...
    private ImageCell.ImageCellBuilder createAndGetGliderImageCellBuilder() throws IOException {
        return ImageCell.builder()
                .verticalAlignment(MIDDLE)
                .horizontalAlignment(CENTER)
                .borderWidth(1)
    ...
    private TextCell.TextCellBuilder createAndGetGliderTextCellBuilder() {
