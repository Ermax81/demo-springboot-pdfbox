...
// Source: https://github.com/vandeseer/easytable/blob/master/src/test/java/org/vandeseer/TestUtils.java
public class TestUtils {

    public static final String TARGET_FOLDER = "src/test/resources";


    public static final String REFERENCE_FOLDER = "src/test/resources/";
